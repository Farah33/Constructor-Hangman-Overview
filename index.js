...
// create var letterwithPlaceHolder
...
// placeholders for all words in wordChoice restart the game
...
var startGame = function() {
    inquirer.prompt([{
        ...
        console.log("GuessLetter: ", letterGuessed)
        console.log("Array: ", wordArray);
        console.log("numberofLetter: ", lettersInWord)
        console.log("lengthWord: ", lengthOfWord);
